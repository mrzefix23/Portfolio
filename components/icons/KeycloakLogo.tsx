...
export const KeycloakLogo = (
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="keycloakGradient" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#4D9FDB" />
          <stop offset="100%" stopColor="#73C2FB" />
        </linearGradient>
      </defs>
      <circle cx="128" cy="125" r="125" fill="url(#keycloakGradient)" />
      <g transform="translate(-5, 0) scale(0.26)">
        <path
