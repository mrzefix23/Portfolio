...
export const Header = () => {
  return (
    <header className="sticky top-0 py-4 bg-background shadow-md z-10">
      <Section className="flex justify-between items-center">
        ...
        <ul className="flex gap-4">
          <Link
            ...
            className={cn(buttonVariants({ variant: "outline" }), "p-2 rounded-full hover:scale-110 transition-transform duration-300")}
            target="_blank"
